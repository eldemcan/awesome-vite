...
- [monorepo-template-react](https://github.com/stormkit-io/monorepo-template-react) - A nimble template for server-side rendering, static page generation, single page apps and API provision.
